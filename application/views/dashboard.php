                                            ...
                                            <div class="sl-item">
                                                ...
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?php echo base_url('assets/images/big/img1.jpg') ?>" alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?php echo base_url('assets/images/big/img2.jpg') ?>" alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?php echo base_url('assets/images/big/img3.jpg') ?>" alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?php echo base_url('assets/images/big/img4.jpg') ?>" alt="user" class="img-responsive radius"></div>
                                                        </div>
